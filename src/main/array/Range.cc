...
Range::Range(Subscript ceiling) : ceiling_(ceiling), iterator_(this) { floor_.assign(ceiling.size(), 1); }
...
Subscript Range::getFloor() { return floor_; }

Subscript Range::getCeiling() { return ceiling_; }

Subscript Range::map(Subscript subscript) { return const_cast<const Range *>(this)->map(subscript); }
...
Range::Iterator::operator Subscript() { return this_; }

void Range::Iterator::operator++() { increment(); }

void Range::Iterator::operator++(int) { increment(); }

void Range::Iterator::operator--() { decrement(); }

void Range::Iterator::operator--(int) { decrement(); }

bool Range::Iterator::operator==(Subscript subscript) { return this_ == subscript; }
...
void Range::Iterator::setOrigin(Subscript origin) { this_ = origin; }
