...
Range::Range(Subscript floor, Subscript ceiling)
    : floor_(floor)
    , ceiling_(ceiling)
    , iterator_(this)
{
...
Subscript
Range::map(Subscript subscript)
{
    return const_cast<const Range*>(this)->map(subscript);
}

Subscript
Range::map(Subscript subscript) const
{
...
Range::Iterator
Range::getIterator(Subscript origin)
{
...
Range::Iterator::Iterator(Range* range)
    : range_(range)
{
    // noop
}
...
bool
Range::Iterator::operator==(Subscript subscript)
{
...
void
Range::Iterator::setOrigin(Subscript origin)
{
    this_ = origin;
}

void
Range::Iterator::increment(int i)
{
...
void
Range::Iterator::decrement(int i)
{
